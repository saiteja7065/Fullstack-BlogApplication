...
//           <Link to="/" className="text-sm/6 font-semibold text-gray-900 hover:text-indigo-600">
//             Home
//           </Link>
//           <Link to="/signup" className="text-sm/6 font-semibold text-gray-900 hover:text-indigo-600">
//             Sign Up
//           </Link>
//           <Link to="/about" className="text-sm/6 font-semibold text-gray-900 hover:text-indigo-600">
//             About Us
//           </Link>
//         </div>
//         <div className="hidden lg:flex lg:flex-1 lg:justify-end">
//           <Link to="/signin" className="text-sm/6 font-semibold text-gray-900 hover:text-indigo-600">
...
//             <img src={currentUser.profileImageUrl} className="rounded-2xl w-8 h-8"/>
//             <p className="text-[0.8rem]">{currentUser.firstName}</p>
//               </div>
...
//                     <img src={currentUser.profileImageUrl} className="rounded-4xl w-13 h-13"/>
