      ...
      <div className="mx-auto w-full max-w-7xl px-8">
            ...
            <div key={key} className="w-full">
              <Typography
                ...
                className={`mb-4 font-bold uppercase ${
                  isNightMode ? "text-gray-400" : "text-white opacity-50"
                }`}
              >
                {title}
              </Typography>
                ...
                {links.map((link, key) => (
                  <Typography
                    ...
                    className={`font-normal ${
                      isNightMode ? "text-gray-300" : "text-white"
                    }`}
                  >
                    <a
                      href="#"
        ...
        <div
          className={`flex w-full flex-col items-center justify-center border-t ${
            isNightMode ? "border-gray-700" : "border-white/30"
        ...
        >
          ...
          >
            ...
            <a
              ...
              className={`${
                isNightMode ? "hover:text-gray-100" : "hover:text-blue-100"
              }`}
            >
              Astra.io
            </a>
          ...
          <div
            className={`flex gap-4 ${
              isNightMode ? "text-gray-400" : "text-white"
            } sm:justify-center`}
          >
            <Typography
              as="a"
